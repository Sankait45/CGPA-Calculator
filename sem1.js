const subjects = [
    {
        name: "Applied Mathematics-I", type: "Theory + TW", credits: 3,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}, {key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24) && (v.tw >= 10)
    },
    {
        name: "Applied Physics", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 30}, {key: "see", label: "SEE", max: 45}],
        checkPass: (v) => (v.cia >= 12) && (v.see >= 18)
    },
    {
        name: "Applied Chemistry", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 30}, {key: "see", label: "SEE", max: 45}],
        checkPass: (v) => (v.cia >= 12) && (v.see >= 18)
    },
    {
        name: "Engineering Mechanics", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24)
    },
    {
        name: "Basic Electrical & Electronics", type: "Theory", credits: 3,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24)
    },
    {
        name: "Applied Physics Lab", type: "Lab", credits: 0.5,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "Applied Chemistry Lab", type: "Lab", credits: 0.5,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "Engineering Mechanics Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Basic Electrical & Electronics Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Professional and Communication Ethics", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 30}, {key: "see", label: "SEE", max: 45}],
        checkPass: (v) => (v.cia >= 12) && (v.see >= 18)
    },
    {
        name: "Professional and Comm Ethics Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "Engineering Workshop-I", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "C Programming", type: "Lab", credits: 2,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Induction cum Universal Human Values", type: "Audit", credits: 2, excludeFromPercentage: true,
        components: [{key: "perc", label: "Equivalent %", max: 100}],
        checkPass: (v) => true // It's graded on participation essentially, so no strict max fail components. If they got an O, just enter 100 here!
    }
];
...
function getGrade(percentage) {
    ...
    if (percentage >= 40) return { grade: "D", point: 4 }; // Sem 1 uses 'D'
...
if (saveBtn) {
    saveBtn.addEventListener("click", () => {
        if (window.currentSemData) {
            localStorage.setItem("sem1_data", JSON.stringify(window.currentSemData));
