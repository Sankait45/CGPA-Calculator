const subjects = [
    {
        name: "Applied Mathematics-II", type: "Theory + TW", credits: 3,
    ...
    {
        name: "Data Structure", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24)
    },
    {
        name: "Engineering Graphics Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Data Structure Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Social Science & Community Services", type: "Lab", credits: 2,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "Indian knowledge System", type: "Lab", credits: 2,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "Engineering Workshop-II", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "Python Programming", type: "Lab", credits: 2,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Semiconductor Physics", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 30}, {key: "see", label: "SEE", max: 45}],
        checkPass: (v) => (v.cia >= 12) && (v.see >= 18)
    },
    {
        name: "Semiconductor Physics Lab", type: "Lab", credits: 0.5,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    },
    {
        name: "Engineering Materials", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 30}, {key: "see", label: "SEE", max: 45}],
        checkPass: (v) => (v.cia >= 12) && (v.see >= 18)
    },
    {
        name: "Engineering Materials Lab", type: "Lab", credits: 0.5,
        components: [{key: "tw", label: "TW", max: 25}],
        checkPass: (v) => (v.tw >= 10)
    }
];
...
function getGrade(percentage) {
    ...
    if (percentage >= 40) return { grade: "D", point: 4 }; // Sem 2 uses 'D'
...
if (saveBtn) {
    saveBtn.addEventListener("click", () => {
        if (window.currentSemData) {
            localStorage.setItem("sem2_data", JSON.stringify(window.currentSemData));
