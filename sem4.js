const subjects = [
    {
        name: "Computational Theory", type: "Theory", credits: 3,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24)
    },
    {
        name: "Database Management System", type: "Theory", credits: 3,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24)
    },
    {
        name: "Operating System", type: "Theory", credits: 3,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24)
    },
    {
        name: "Multidisciplinary Minor", type: "Theory", credits: 3,
        components: [{key: "cia", label: "CIA", max: 40}, {key: "see", label: "SEE", max: 60}],
        checkPass: (v) => (v.cia >= 16) && (v.see >= 24)
    },
    {
        name: "Open Elective", type: "Theory", credits: 2,
        components: [{key: "cia", label: "CIA", max: 20}, {key: "see", label: "SEE", max: 30}],
        checkPass: (v) => (v.cia >= 8) && (v.see >= 12)
    },
    {
        name: "Database Management System Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Operating System Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Multidisciplinary Minor Lab", type: "Lab", credits: 1,
        components: [{key: "tw", label: "TW", max: 25}, {key: "pr", label: "ORAL", max: 25}],
        checkPass: (v) => (v.tw >= 10) && (v.pr >= 10)
    },
    {
        name: "Mini Project-I", type: "Lab", credits: 2,
        components: [{key: "tw", label: "TW", max: 50}, {key: "pr", label: "OR/PR", max: 25}],
        checkPass: (v) => (v.tw >= 20) && (v.pr >= 10)
    },
    {
        name: "Business Model Development", type: "Lab", credits: 2,
        components: [{key: "tw", label: "TW", max: 50}],
        checkPass: (v) => (v.tw >= 20)
    },
    {
        name: "Design Thinking", type: "Lab", credits: 2,
        components: [{key: "tw", label: "TW", max: 50}],
        checkPass: (v) => (v.tw >= 20)
    }
];
...
function getGrade(percentage) {
    ...
    if (percentage >= 40) return { grade: "P", point: 4 }; // Note: Sem 4 explicitly uses 'P' instead of 'D' for 40-50%
...
if (saveBtn) {
    saveBtn.addEventListener("click", () => {
        if (window.currentSemData) {
            localStorage.setItem("sem4_data", JSON.stringify(window.currentSemData));
